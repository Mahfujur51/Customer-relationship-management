  ...
  <div class="page-content">
    ...
    <div class="content">
     ...
     <?php
        ...
        $sql="SELECT * FROM  tbl_ticket  WHERE email='$email'";
            ...
            <div class="grid-body  no-border" style="display:none">
              ...
              <div class="form-actions">
                <div class="post col-md-12">
                  <div class="user-profile-pic-wrapper">
                    <div class="user-profile-pic-normal"> <img width="35" height="35" data-src-retina="userimages/user.jpg"
                     data-src="userimages/user.jpg" src="userimages/user.jpg" alt=""> </div>
                  </div>
                  <div class="info-wrapper">
                      ...
                      <hr>
                      <p class="small-text">Posted on <?php echo $result['admin_remake_date'];?></p>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="clearfix"></div>
